...
public class Country {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement element = driver.findElement(By.xpath("//li[@id = 'topsites-country']/a"));
		element.click();
		// It will display the page title

		System.out.println("Page title is: " + driver.getTitle());

		List<WebElement> titles = driver.findElements(By.cssSelector("ul[class='countries span3'] li a"));
		...
		for (int j = 0; j < titles.size(); j++) {
			...
			// Continue the countries
			titles = driver.findElements(By.cssSelector("ul[class='countries span3'] li a"));
